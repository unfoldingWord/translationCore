...
jest.mock('../src/js/actions/MergeConflictActions', () => ({ validate: () => ({ type: 'VALIDATE' }) }));
jest.mock('../src/js/actions/WordAlignmentActions', () => ({ getUsfm3ExportFile: () => () => Promise.resolve('a usfm3 string') }));
