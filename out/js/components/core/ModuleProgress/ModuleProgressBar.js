...
var Progress = React.createClass({
  ...
  render: function () {
    return React.createElement(
      'div',
      { style: this.state.style, 'max-width': "1000px", margin: "auto" },
      React.createElement(ProgressBar, { striped: true, bsStyle: 'warning', now: this.state.progress, max: this.state.max, label: this.state.label })
    );
  }
