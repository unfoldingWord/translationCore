...
const Registration = React.createClass({
  ...
  createUser: function () {
    ...
    if (emailValid === 'success' && passwordMatch === 'success' && unLen > 0) {
      GogsApi(Token).createAccount(user).then(function (data) {
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        FormGroup,
        { controlId: 'username' },
        React.createElement(FormControl, { type: 'text', placeholder: ENTER.username, onChange: this.handleUser })
      ),
      React.createElement(
        FormGroup,
        { controlId: 'email', validationState: this.validateEmail() },
        React.createElement(FormControl, { type: 'text', placeholder: ENTER.email, onChange: this.handleEmail }),
        React.createElement(FormControl.Feedback, null)
      ),
      React.createElement(
        FormGroup,
        { controlId: 'password', validationState: this.checkPass() },
        React.createElement(FormControl, { type: 'password', placeholder: ENTER.password, onChange: this.handlePass }),
        React.createElement(FormControl.Feedback, null)
      ),
      React.createElement(
        FormGroup,
        { controlId: 'confirm', validationState: this.checkPass() },
        React.createElement(FormControl, { type: 'password', placeholder: ENTER.confirm, onChange: this.handleConfirm }),
        React.createElement(FormControl.Feedback, null)
      ),
      React.createElement(
        Button,
