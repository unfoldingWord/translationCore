    ...
    return (
      <div>
        ...
        <div style={{color: "black", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
          ...
          <p>
            <b>Attribution</b> —  You must attribute the work as follows: &quote;Original work available&nbsp;
            at https://git.door43.org/.&quote; Attribution statements in derivative works should not in any way&nbsp;
