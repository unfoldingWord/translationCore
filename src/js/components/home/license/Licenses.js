...
const Licenses = () => {
  return(
    <div style={{padding: '40px 10px 40px 0px', height: "520px", overflowY: "auto", marginRight: "-10px"}}>
      ...
      <center><h2><b>{"Third Party Code Additional Copyright Notices and License Terms"}</b></h2></center>
      <ThirdPartyCode />
    </div>
  )
}
