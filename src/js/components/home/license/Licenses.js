...
const Licenses = ({ translate }) => (
  <div style={{
    padding: '40px 10px 40px 0px', height: '520px', overflowY: 'auto', marginRight: '-22px', textAlign:'center',
  }}>
    ...
    <h3>{translate('third_party_attributions')}</h3>
...
Licenses.propTypes = { translate: PropTypes.func.isRequired };
