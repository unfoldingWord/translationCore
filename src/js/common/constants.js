...
export const PROJECTS_PATH = path.join(USER_HOME, 'translationCore', 'projects');
export const USER_RESOURCES_PATH = path.join(USER_HOME, 'translationCore', 'resources');
export const IMPORTS_PATH = path.join(USER_HOME, 'translationCore', 'imports');
export const VIEW_DATA_PATH = path.join(USER_HOME, 'translationCore', 'viewUrl');
export const PROJECT_INDEX_FOLDER_PATH = path.join('.apps', 'translationCore', 'index');
export const TEMP_IMPORT_PATH = path.join(USER_HOME, 'translationCore', 'imports', 'temp');
...
export const LOG_FILES_PATH = path.join(USER_HOME, 'translationCore', 'logs');
