...
export function loadProjectData(currentToolName) {
  return ((dispatch, getState) => {
    ...
    return new Promise(() => {
      ...
      let glDataDirectory = ''; // default is that if resource doesn't exist, groups index will be generated
      if (currentToolName !== 'wordAlignment') { // wordAlignment groups index will be generated
