...
export function loadProjectData(currentToolName) {
  return ((dispatch, getState) => {
    ...
    return new Promise(() => {
      ...
      let glDataDirectory = ''; // default is that if resource doesn't exist, an empty groups index will be generated by getGroupsIndex().
      ...
      if (versionDirectory) { // if resources version is found, then get path for group index data to load
