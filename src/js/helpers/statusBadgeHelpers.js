  ...
  if (glyphs && glyphs.length) {
    glyphs.forEach((glyph)=>{
      if (glyph === 'invalidated') {
        glyphicons.push(getInvalidatedIcon());
      } else {
...
/**
 * This svg markup was obtained from here: https://www.flaticon.com/free-icon/unlink-symbol_25341
 */
export function getInvalidatedIcon() {
  return (
    <svg className="glyphicon glyphicon-invalidated" style={style.menuItem.statusIcon.invalidated} xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 475.082 475.082">
