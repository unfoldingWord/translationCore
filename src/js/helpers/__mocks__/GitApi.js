...
export const mockInit = jest.fn(async (callback) => {
  return callback(__data.mockInit_Ret);
});
export const mockStatus = jest.fn(async (callback) => {
  return callback(__data.mockStatus_Error, __data.mockStatus_Ret);
});
export const mockGetRemoteRepoHead = jest.fn(async () => {
  return __data.mockGetRemoteRepoHead_Ret;
});
