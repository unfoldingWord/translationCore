...
## [v2.0.0](https://github.com/unfoldingWord-dev/translationCore/tree/v2.0.0) (2019-08-15)
...
- WordMAP Integration: Consume whole language \(per identifier\) [\#5662](https://github.com/unfoldingWord-dev/translationCore/issues/5662)
...
- tA links and extraneous verbiage is showing in tN smurf bar when GL is Hindi [\#6296](https://github.com/unfoldingWord-dev/translationCore/issues/6296)
- In tN, the English text is displayed in the smurf bar instead of the GL [\#6275](https://github.com/unfoldingWord-dev/translationCore/issues/6275)
...
- wA tool card shows 0% complete after importing a fully aligned usfm project [\#6181](https://github.com/unfoldingWord-dev/translationCore/issues/6181)
- Only display GL's in the GL dropdown list on the tN card if there are tN's defined for the GL/project combination. [\#6177](https://github.com/unfoldingWord-dev/translationCore/issues/6177)
- Gateway Languages are displayed and the wrong message is displayed for tN Launch button when there are no corresponding tN's [\#6174](https://github.com/unfoldingWord-dev/translationCore/issues/6174)
...
- In the alignment tool, selected words in the word bank should automatically be unselected when navigating to a different verse or clicking outside of the word bank [\#5175](https://github.com/unfoldingWord-dev/translationCore/issues/5175)
- Remove unnecessary reload of tool [\#5135](https://github.com/unfoldingWord-dev/translationCore/issues/5135)

**Closed issues:**

- GL is not available for selection in tW. [\#6363](https://github.com/unfoldingWord-dev/translationCore/issues/6363)
- Import Project with Overwrite fails when tC is running [\#6328](https://github.com/unfoldingWord-dev/translationCore/issues/6328)
- Selections are not saved when GL is switched in tN [\#6327](https://github.com/unfoldingWord-dev/translationCore/issues/6327)
- % complete not working on tN tools card [\#6314](https://github.com/unfoldingWord-dev/translationCore/issues/6314)
- Bug exporting project to USFM when canceling export [\#6309](https://github.com/unfoldingWord-dev/translationCore/issues/6309)
- Update Localization strings for Door43 - already fixed [\#6303](https://github.com/unfoldingWord-dev/translationCore/issues/6303)
- Original language is showing as an option in the GL dropdown list for wA [\#6297](https://github.com/unfoldingWord-dev/translationCore/issues/6297)
- Fix Lemma fallback [\#6295](https://github.com/unfoldingWord-dev/translationCore/issues/6295)
- tC crashes when returning to Tools page [\#6289](https://github.com/unfoldingWord-dev/translationCore/issues/6289)
- Feedback window has UI issue [\#6285](https://github.com/unfoldingWord-dev/translationCore/issues/6285)
- When Export to USFM is cancelled, tC hangs up [\#6270](https://github.com/unfoldingWord-dev/translationCore/issues/6270)
- Critical Error Handling [\#6256](https://github.com/unfoldingWord-dev/translationCore/issues/6256)
...
- Dissimilarities between the Bookmark switch and the Alignment Complete switch [\#6226](https://github.com/unfoldingWord-dev/translationCore/issues/6226)
- Update list of libraries/NPM packages/fonts [\#6225](https://github.com/unfoldingWord-dev/translationCore/issues/6225)
- Update tC to handle ellipses \(instead of `space-three periods-space`\) in tN [\#6222](https://github.com/unfoldingWord-dev/translationCore/issues/6222)
...
- In tN, Code appearing in selection pane when there is no highlight in the scripture pane [\#6192](https://github.com/unfoldingWord-dev/translationCore/issues/6192)
...
- Show verse edit Indication in all tools regardless of where the edit was performed [\#5832](https://github.com/unfoldingWord-dev/translationCore/issues/5832)
...
- Edits made external to tC that invalidate selections are not caught until the project is opened in tW [\#5686](https://github.com/unfoldingWord-dev/translationCore/issues/5686)
...
- tC should default the Gateway Language selection to the last selected for the chosen project [\#4102](https://github.com/unfoldingWord-dev/translationCore/issues/4102)
